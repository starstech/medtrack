  ...
  WHILE current_day <= end_date LOOP
    ...
    CASE medication_record.frequency
      WHEN 'daily' THEN
        ...
        VALUES (med_uuid, current_day + INTERVAL '9 hours');
      ...
      WHEN 'twice_daily' THEN
        ...
        VALUES (med_uuid, current_day + INTERVAL '9 hours');
        INSERT INTO api.doses (medication_id, scheduled_time)
        VALUES (med_uuid, current_day + INTERVAL '21 hours');
        dose_count := dose_count + 2;
        
      WHEN 'three_times_daily' THEN
        INSERT INTO api.doses (medication_id, scheduled_time)
        VALUES (med_uuid, current_day + INTERVAL '8 hours');
        INSERT INTO api.doses (medication_id, scheduled_time)
        VALUES (med_uuid, current_day + INTERVAL '14 hours');
        INSERT INTO api.doses (medication_id, scheduled_time)
        VALUES (med_uuid, current_day + INTERVAL '20 hours');
        dose_count := dose_count + 3;
        
      WHEN 'four_times_daily' THEN
        INSERT INTO api.doses (medication_id, scheduled_time)
        VALUES (med_uuid, current_day + INTERVAL '6 hours');
        INSERT INTO api.doses (medication_id, scheduled_time)
        VALUES (med_uuid, current_day + INTERVAL '12 hours');
        INSERT INTO api.doses (medication_id, scheduled_time)
        VALUES (med_uuid, current_day + INTERVAL '18 hours');
        INSERT INTO api.doses (medication_id, scheduled_time)
        VALUES (med_uuid, current_day + INTERVAL '24 hours');
