...
CRON JOBS TO SETUP:
1. Medication reminders: */15 * * * * (every 15 minutes)
2. Overdue dose checks: */30 * * * * (every 30 minutes)  
3. Daily cleanup: 0 2 * * * (daily at 2 AM)
4. Weekly reports: 0 9 * * 1 (Mondays at 9 AM)
*/ 